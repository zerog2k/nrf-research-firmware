...
from lib.nrf24 import RF_RATES
...
# get the data rate
datarate = common.radio.get_data_rate()
print("datarate: %s" % RF_RATES[datarate[0]])

print("changing to 1M")
common.radio.set_data_rate(RF_RATES.index("RF_RATE_1M"))
